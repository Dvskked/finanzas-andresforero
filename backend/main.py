...
app = FastAPI(
    title="API de Finanzas AF",
    description=(
        "Backend RESTful con arquitectura por capas para Finanzas AF (Andres Forero). "
        "Gestión de finanzas personales: usuarios, categorías, movimientos, "
        "resúmenes y analítica predictiva."
    ),
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc"
...
def health_check():
    ...
    return {
        "status": "ok",
        "message": "API de Finanzas AF funcionando correctamente"
    }
