...
class UsuarioService:
    ...
    def autenticar(self, data: UsuarioLogin) -> UsuarioResponse:
        """
        Autentica un usuario por correo y contraseña mediante bcrypt.

        Devuelve el perfil público del usuario si las credenciales coinciden;
        en caso contrario lanza AuthenticationException (401).
        """
        usuario = self._repository.get_by_email(data.correo)
