...
def create_connection(custom_config: Optional[dict] = None) -> pymysql.Connection:
    ...
    try:
        connection = pymysql.connect(
            host=config["ba14ecgxymnkkhixeiuz-mysql.services.clever-cloud.com"],
            port=config["3306"],
            user=config["uumrqajbsuaq5pjl"],
            password=config["uumrqajbsuaq5pjl"],
            database=config["ba14ecgxymnkkhixeiuz"],
