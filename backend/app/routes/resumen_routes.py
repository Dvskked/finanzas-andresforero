...
from app.core.dependencies import get_resumen_service
...
@router.get(
    ...
    description=(
        ...
        "de un usuario para un periodo mensual. Un periodo sin movimientos "
        "devuelve 200 con los tres importes en 0.00."
    )
)
def obtener_resumen_financiero(
    ...
    """
    return service.obtener_resumen_mensual(id_usuario=id_usuario, mes=mes)
